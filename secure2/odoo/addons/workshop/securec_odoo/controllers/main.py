...
class SecureCController(http.Controller):
    ...
    @http.route('/securec/metrics', type='jsonrpc', auth='user', methods=['POST'])
    ...
    @http.route('/securec/activity_feed', type='jsonrpc', auth='user', methods=['POST'])
    ...
    @http.route('/securec/logs', type='jsonrpc', auth='user', methods=['POST'])
    ...
    @http.route('/securec/audit_logs', type='jsonrpc', auth='user', methods=['POST'])
    ...
    @http.route('/securec/active_policy', type='jsonrpc', auth='user', methods=['POST'])
    ...
    @http.route('/securec/policies', type='jsonrpc', auth='user', methods=['POST'])
    ...
    @http.route('/securec/active_policy/set', type='jsonrpc', auth='user', methods=['POST'])
    ...
    @http.route('/securec/context', type='jsonrpc', auth='user', methods=['POST'])
    ...
    @http.route('/securec/simulate', type='jsonrpc', auth='user', methods=['POST'])
    ...
    @http.route('/securec/waf/input', type='jsonrpc', auth='user', methods=['POST'])
...
"""
    ...
    @http.route('/securec/attack_lab/run', type='jsonrpc', auth='user', methods=['POST'])
